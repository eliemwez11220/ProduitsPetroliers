<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('affectation/edit/'.$affectation['affec_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="chauffeur_sid" class="form-control">
								...
								{
									$selected = ($chauffeur['cha_id'] == $affectation['chauffeur_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="charroi_sid" class="form-control">
								...
								{
									$selected = ($charroi['cha_id'] == $affectation['charroi_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateAffec" value="<?php echo ($this->input->post('dateAffec') ? $this->input->post('dateAffec') : $affectation['dateAffec']); ?>" class="has-datepicker form-control" id="dateAffec" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="observation" class="control-label">Observation</label>
						<div class="form-group">
							<textarea name="observation" class="form-control" id="observation"><?php echo ($this->input->post('observation') ? $this->input->post('observation') : $affectation['observation']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
