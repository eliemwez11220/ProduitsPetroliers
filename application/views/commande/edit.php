    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Commande Edit</h3>
            </div>
			<?php echo form_open('commande/edit/'.$commande['com_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="abonne_sid" class="form-control">
								...
								{
									$selected = ($abonne['abo_id'] == $commande['abonne_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="produit_sid" class="form-control">
								...
								{
									$selected = ($produit['pro_id'] == $commande['produit_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="zone_sid" class="form-control">
								...
								{
									$selected = ($zone['zone_id'] == $commande['zone_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="charroi_sid" class="form-control">
								...
								{
									$selected = ($charroi['cha_id'] == $commande['charroi_sid']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="numRef" value="<?php echo ($this->input->post('numRef') ? $this->input->post('numRef') : $commande['numRef']); ?>" class="form-control" id="numRef" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="dateCom" value="<?php echo ($this->input->post('dateCom') ? $this->input->post('dateCom') : $commande['dateCom']); ?>" class="has-datepicker form-control" id="dateCom" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="qteCom" class="control-label"><span class="text-danger">*</span>QteCom</label>
						<div class="form-group">
							<input type="text" name="qteCom" value="<?php echo ($this->input->post('qteCom') ? $this->input->post('qteCom') : $commande['qteCom']); ?>" class="form-control" id="qteCom" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="observation" class="form-control" id="observation"><?php echo ($this->input->post('observation') ? $this->input->post('observation') : $commande['observation']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
