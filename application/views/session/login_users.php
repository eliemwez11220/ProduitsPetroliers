...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | Distribution Produits Petrolier Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <p>
                          Applicattion de gestion de Distribution de Produits Petrolier
                        </p>
                        <hr>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <p class="small">
                            Vous n'etes pas encore abonne?
                        </p>
                      </div>
                      <div class="col-sm-6">
                            <a href="<?= base_url('internaute/creerCompteClient'); ?>"
                                class="text-primary font-weight-bold btn-block btn-link ">
                            Abonnez-vous</a>
                      </div>
                  </div>-->
                </div>
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/coding.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: white; font-weight: bold;">
                              Application</a>
                        </span>
